    ...
    return (
        <div className={styles.windowWrapper}>
            ...
            <section className="hero-section pt-20 pb-120 position-relative">
                ...
                <p style={{ textAlign: 'right', marginRight: '4rem', fontFamily: 'Chakra Petch' }}>Made with <img src='https://cdn-icons-png.flaticon.com/128/210/210545.png' alt='heart' style={{ width: '24px' }} /> By <a href="https://www.linkedin.com/in/udit-gupta-ug0510/" target="_blank"> Udit Gupta</a></p>
